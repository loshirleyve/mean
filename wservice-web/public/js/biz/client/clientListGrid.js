    ...
    .factory("ClientListGrid", function (nptGridStore) {
        return nptGridStore("ClientListGrid", {
            ...
            mobile: {
                fields: {
                    title: "name",
                    content:"'<div class=\"row\"><div class=\"col-xs-4\"><span class=\"glyphicon glyphicon-user\"></span>' + '&nbsp;' + contactman + '</div>' + '&nbsp;' + '<div class=\"col-xs-5\"><span class=\"glyphicon glyphicon-phone\"></span>' + '&nbsp;' + contactphone + '</div></div>'",
