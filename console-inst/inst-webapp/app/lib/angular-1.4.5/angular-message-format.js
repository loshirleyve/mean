 ...
 * ## Example
 *
 * <example name="ngMessageFormat-example" module="msgFmtExample" deps="angular-1.4.5-message-format.min.js">
 ...
 *
 *   angular-1.4.5.module('msgFmtExample', ['ngMessageFormat'])
...
var $$interpolateDecorator = ['$$messageFormat', '$delegate', function $$interpolateDecorator($$messageFormat, $interpolate) {
  if ($interpolate['startSymbol']() != "{{" || $interpolate['endSymbol']() != "}}") {
    throw $interpolateMinErr('nochgmustache', 'angular-1.4.5-message-format.js currently does not allow you to use custom start and end symbols for interpolation.');
  }
 ...
 * @packageName angular-1.4.5-message-format
 * @description
 */
