...
.directive('docTutorialNav', function() {
  ...
  return {
    ...
    template:
      ...
      '<a ng-href="http://angular-1.4.5.github.io/angular-1.4.5-phonecat/step-{{seq}}/app"><li class="btn btn-primary"><i class="glyphicon glyphicon-play"></i> Live Demo</li></a>\n' +
      '<a ng-href="https://github.com/angular-1.4.5/angular-1.4.5-phonecat/compare/step-{{diffLo}}...step-{{diffHi}}"><li class="btn btn-primary"><i class="glyphicon glyphicon-search"></i> Code Diff</li></a>\n' +
  ...
  return {
    ...
    template:
      ...
      '  <p>Refresh your browser or check out this step online: '+
          '<a href="http://angular-1.4.5.github.io/angular-1.4.5-phonecat/step-{{step}}/app">Step {{step}} Live Demo</a>.</p>\n' +
      '</div>\n' +
      '<p>The most important changes are listed below. You can see the full diff on ' +
        '<a ng-href="https://github.com/angular-1.4.5/angular-1.4.5-phonecat/compare/step-{{step ? (step - 1): \'0~1\'}}...step-{{step}}" title="See diff on Github">GitHub</a>\n' +
      '</p>'
  };
});
"use strict";
