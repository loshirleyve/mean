    ...
    function areAnimationsAllowed(element, parentElement, event) {
      ...
      while (parentElement && parentElement.length) {
        if (!rootElementDetected) {
          // angular-1.4.5 doesn't want to attempt to animate elements outside of the application
 ...
 *
 *       // remember to call doneFn so that angular-1.4.5
 ...
 *
  <example module="anchoringExample"
           ...
           id="anchoringExample"
           deps="angular-1.4.5-animate.js;angular-1.4.5-route.js"
           animations="true">
    ...
    <file name="script.js">
      angular-1.4.5.module('anchoringExample', ['ngAnimate', 'ngRoute'])
 ...
 * ```
 *
 * (Note that you will need to trigger a digest within the callback to get angular-1.4.5 to notice any scope-related changes.)
 */
