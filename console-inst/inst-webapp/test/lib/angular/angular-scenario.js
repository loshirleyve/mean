 ...
 *
 * Note: this function was previously known as `angular-1.4.5.foreach`.
 *
   <pre>
     var values = {name: 'misko', gender: 'male'};
     var log = [];
     angular-1.4.5.forEach(values, function(value, key){
       this.push(key + ': ' + value);
     }, log);
...
/**
 * A consistent way of creating unique IDs in angular-1.4.5. The ID is a sequence of alpha numeric
 ...
 * functional style.
   <pre>
     function foo(callback) {
       ...
       (callback || angular-1.4.5.noop)(result);
     }
   </pre>
 */
function noop() {}
 ...
 * @description
 * Use this function to manually start up angular-1.4.5 application.
 *
 * See: {@link guide/bootstrap Bootstrap}
 *
 * @param {Element} element DOM element which is the root of angular-1.4.5 application.
 ...
 * @description
 *
 * Interface for configuring angular-1.4.5 {@link angular.module modules}.
 */
...
function setupModuleLoader(window) {
  ...
  return ensure(ensure(window, 'angular', Object), 'module', function() {
     ...
     * @description
     *
     * The `angular-1.4.5.module` is a global place for creating and registering Angular modules. All
     * modules (angular-1.4.5 core or 3rd party) that should be available to an application must be
     ...
     * <pre>
     * // Create a new module
     * var myModule = angular-1.4.5.module('myModule', []);
     *
     ...
     *
     * <pre>
     * var injector = angular-1.4.5.injector(['ng', 'MyModule'])
     * </pre>
     *
    ...
    return function module(name, requires, configFn) {
      ...
      return ensure(modules, name, function() {
        ...
        var moduleInstance = {
           ...
           * @propertyOf angular-1.4.5.Module
 ...
 * `angular-1.4.5.element` can be either an alias for [jQuery](http://api.jquery.com/jQuery/) function, if
 ...
 * <pre>
 *   // create an injector
 *   var $injector = angular-1.4.5.injector(['ng']);
 *
 ...
 *
 * <pre>
 *   var $injector = angular-1.4.5.injector();
 ...
 *       expect(greet('angular-1.4.5')).toEqual('Hello angular-1.4.5!');
 *     }));
 *
 ...
 *         expect(greet('angular-1.4.5')).toEqual('Ahoj angular-1.4.5!');
 *       });
 *     )};
 *
 *   });
...
function Browser(window, document, $log, $sniffer) {
   ...
   *
   * It's only called when the url is changed by outside of angular-1.4.5:
   ...
   *
   * NOTE: this api is intended for use only by the $location service. Please use the
   * {@link ng.$location $location service} to monitor url changes in angular-1.4.5 apps.
   *
 ...
 <doc:example module="compile">
   <doc:source>
    <script>
      ...
      angular-1.4.5.module('compile', [], function($compileProvider) {
 ...
 * @param {function(angular-1.4.5.Scope[, cloneAttachFn]} transclude function available to directives.
 ...
 *   <pre>
 *     var templateHTML = angular-1.4.5.element('<p>{{total}}</p>'),
 *         scope = ....;
 *
 ...
 *
 * @description
 * Any uncaught exception in angular-1.4.5 expressions is delegated to this service.
 * The default implementation simply delegates to `$log.error` which logs it into
 * the browser console.
 *
 * In unit tests, if `angular-1.4.5-mocks.js` is loaded, this service is overridden by
 ...
 *   var context = {user:{name:'angular-1.4.5'}};
 *   var locals = {user:{name:'local'}};
 *
 *   expect(getter(context)).toEqual('angular-1.4.5');
 ...
 *   mechanism in angular-1.4.5, which means faster propagation of resolution or rejection into your
 *   models and avoiding unnecessary browser repaints, which would result in flickering UI.
 * - $q promises are recognized by the templating engine in angular-1.4.5, which means that in templates
  ...
  this.$get = ['$rootScope', '$location', '$routeParams', '$q', '$injector', '$http', '$templateCache',
     ...
     * @example
     ...
     <example module="ngView">
       ...
       <file name="script.js">
         angular-1.4.5.module('ngView', [], function($routeProvider, $locationProvider) {
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse',
     ...
     * <pre>
        angular-1.4.5.injector(['ng']).invoke(function($rootScope) {
    ...
    Scope.prototype = {
      ...
      $destroy: function() {
        ...
        // see: https://github.com/angular-1.4.5/angular-1.4.5.js/issues/1313#issuecomment-10378451
       ...
       * </pre>
       *
       * @param {(string|function())=} expression An angular-1.4.5 expression to be executed.
       *
       ...
       *
       * @description
       * `$apply()` is used to execute an expression in angular-1.4.5 from outside of the angular-1.4.5 framework.
       * (For example from browser DOM events, setTimeout, XHR or third party libraries).
       * Because we are calling into the angular-1.4.5 framework we need to perform proper scope life-cycle
       ...
       *
       *
       * @param {(string|function())=} exp An angular-1.4.5 expression to be executed.
       *
       *    - `string`: execute using the rules as defined in {@link guide/expression expression}.
...
function $SnifferProvider() {
  this.$get = ['$window', function($window) {
    ...
    return {
      ...
      // https://github.com/angular-1.4.5/angular-1.4.5.js/issues/904
 ...
 * it is a global variable. In angular-1.4.5 we always refer to it through the
 ...
 *
 *
 * For more information about how angular-1.4.5 filters work, and how to create your own filters, see
 * {@link guide/dev_guide.templates.filters Understanding Angular Filters} in the angular-1.4.5 Developer
 * Guide.
 */
/**
 * @ngdoc method
 ...
 * angular-1.4.5 has a chance to replace the {{hash}} with actual URL, the
 ...
 * This prevents the angular-1.4.5 compiler from correctly retrieving the binding expression.
 ...
 *
 * In angular-1.4.5 forms can be nested. This means that the outer form is valid when all of the child
 * forms are valid as well. However browsers do not allow nesting of `<form>` elements, for this
 * reason angular-1.4.5 provides {@link ng.directive:ngForm `ngForm`} alias
...
var inputType = {
   ...
   *
   * @description
   * Standard HTML text input with angular-1.4.5 data binding.
   *
   * @param {string} ngModel Assignable angular-1.4.5 expression to data-bind to.
 ...
 *
 * @description
 * HTML textarea element control with angular-1.4.5 data-binding. The data-binding and validation
 ...
 *
 * @description
 * HTML input element control with angular-1.4.5 data-binding. Input control follows HTML5 input types
 ...
 * <example module="customControl">
    ...
    <file name="script.js">
      angular-1.4.5.module('customControl', []).
 ...
 *
 * `ngCloak` works in cooperation with a css rule that is embedded within `angular-1.4.5.js` and
 *  `angular-1.4.5.min.js` files. Following is the css rule:
 *
 * <pre>
 ...
 *
 * For the best result, `angular-1.4.5.js` script must be loaded in the head section of the html file;
 ...
 *
 * @description
 * The `ngController` directive assigns behavior to a scope. This is a key aspect of how angular-1.4.5
 * supports the principles behind the Model-View-Controller design pattern.
 *
 * MVC components in angular-1.4.5:
 *
 ...
 * easily be called from the angular-1.4.5 markup. Notice that the scope becomes the `this` for the
 ...
 */
/*
 * A directive that allows creation of custom onclick handlers that are defined as angular-1.4.5
 ...
 *
 * @description
 * Enables binding angular-1.4.5 expressions to onsubmit events.
 *
 ...
 * @scope
 *
 * @param {string} ngInclude|src angular-1.4.5 expression evaluating to URL. If the source is a string constant,
 ...
 * by angular-1.4.5. Use `ngNonBindable` to make angular-1.4.5 ignore a chunk of HTML.
 *
 * @element ANY
 *
 * @example
 ...
 * These rules are bundled with angular-1.4.5.js and the rules can be overridden
   ...
   <doc:example module="transclude">
     <doc:source>
       <script>
         ...
         angular-1.4.5.module('transclude', [])
 ...
 *
 * @description
 * HTML `SELECT` element with angular-1.4.5 data-binding.
 *
 * # `ngOptions`
 *
 ...
 * for all pending angular-1.4.5 xhr requests before executing.
 *
 ...
 *    with angular-1.4.5.scenario.matcher
 *
 ...
 *  to use angular-1.4.5 bindings for the UI.
 */
angular.scenario.output('html', function(context, runner, model) {
  ...
  context.append(
    '<div id="header">' +
    '  <h1><span class="angular-1.4.5">AngularJS</span>: Scenario Test Runner</h1>' +
